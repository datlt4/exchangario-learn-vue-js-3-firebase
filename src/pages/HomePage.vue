<template>
  <div id="exchangario">
    <!-- NAVBAR -->
    <exchange-navbar v-bind:title="brandName" v-bind:items="menuItems" />
    <!-- HERO -->
    <exchange-hero />
    <!-- POST LIST START -->
    <exchange-list v-bind:exchanges="exchanges" />
    <!-- PAGINATION START -->
    <exchange-pagination />
  </div>
</template>
...
<script>
import ExchangeNavbar from "../components/NavigationBar0.vue";
import ExchangeHero from "../components/HeroComponent.vue";
